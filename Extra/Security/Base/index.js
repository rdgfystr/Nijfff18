...
if (!fs.existsSync(process.cwd() + '/Nazrul_Database') || !fs.existsSync(process.cwd() + '/Nazrul_Database/RandPass.json')) {
  ...
  if (!fs.existsSync(process.cwd() + '/Nazrul_Database')) {
    fs.mkdirSync(process.cwd() + '/Nazrul_Database');
  }
  fs.writeFileSync(process.cwd() + '/Nazrul_Database/RandPass.json', JSON.stringify(ArrPassWord, null, 2), 'utf8');
}

else {
  ArrPassWord = JSON.stringify(fs.readFileSync(process.cwd() + '/Nazrul_Database/RandPass.json'));
}
